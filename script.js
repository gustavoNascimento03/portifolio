...
const translations = {
    pt: { 
        ...
        aboutP1: "Olá! Sou um desenvolvedor Fullstack apaixonado por criar soluções digitais que sejam tanto funcionais quanto visualmente atraentes. Minha jornada na programação começou com a curiosidade de entender como as coisas funcionavam por baixo dos panos, e hoje essa curiosidade me move a aprender e aplicar novas tecnologias constantemente.", 
        aboutP2: "Trabalho com o ciclo completo de desenvolvimento, desde o design da interface no front-end até a arquitetura do servidor e banco de dados no back-end. Acredito que a melhor solução é aquela que resolve o problema do usuário de forma simples e eficaz.", 
        projectsTitle: "Projetos", 
        project1Title: "E-commerce Moderno", 
        project1Desc: "Plataforma de vendas completa com React, Node.js e Stripe.", 
    ...
    en: { 
        ...
        aboutTitle: "About Me", 
        aboutP1: "Hello! I'm a Fullstack developer passionate about creating digital solutions that are both functional and visually appealing. My programming journey began with a curiosity to understand how things worked under the hood, and today that curiosity drives me to constantly learn and apply new technologies.", 
        aboutP2: "I work with the complete development cycle, from front-end interface design to back-end server and database architecture. I believe the best solution is one that solves the user's problem simply and effectively.", 
        projectsTitle: "Projects", 
        project1Title: "Modern E-commerce", 
        project1Desc: "Complete sales platform with React, Node.js, and Stripe.", 
